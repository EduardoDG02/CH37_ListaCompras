...
//Limpia toda la lista incluyendo los cambios
...
btnClear.addEventListener("click", function (event){
    //evita que ejecute con el navegador
...
btnAgregar.addEventListener("click", function(event){
    ...
    if (! validarCantidad() ){
        alertValidacionesTexto.insertAdjacentHTML("beforeend", `La <strong> Cantidad</srong> no es correcta`)
        alertValidaciones.style.display="block";
...
window.addEventListener("load", function(event){
    ...
    if (this.localStorage.getItem("contador") !=null) {
        ...
        totalEnProductos = Number (this.localStorage.getItem("contadorProductos"));
